...
class Model(models.Model):
    ...
    rotation = models.FloatField(null=True, default=0.0 , help_text="Rotation in degrees")
    scale = models.FloatField(null=True, default=1.0 , help_text="Scale factor")
    translation_x = models.FloatField(null=True, default=0.0 , help_text="X translation")
    translation_y = models.FloatField(null=True, default=0.0 , help_text=" Y translation")
    translation_z = models.FloatField(null=True, default=0.0 , help_text= "Z translation")
